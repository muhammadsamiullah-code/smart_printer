...
class BrowsePdfFileScreen extends StatefulWidget {
  ...
  @override
  State<BrowsePdfFileScreen> createState() => _BrowsePdfFileScreenState();
}

class _BrowsePdfFileScreenState extends State<BrowsePdfFileScreen> {
  List<File> pdfFiles = [];
  ...
  Future<void> openBrowser() async {
    final updated = await Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => BrowswePDFScreen(title: widget.title)),
    );
