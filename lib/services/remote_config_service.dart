...
class RemoteConfigService {
  ...
  static bool get bannerEnabled =>
      _remoteConfig.getBool('ads_banner_enabled');
      
  static String get bannerAdId =>
      _remoteConfig.getString('ads_banner_id');
  ...
  static String get interstitialAdId =>
    ...
    static int get clickGap =>
      _remoteConfig.getInt('ads_interstitial_click_gap');

  static bool get appOpenEnabled =>
      _remoteConfig.getBool('ads_app_open_enabled');

    static String get appOpenAdId =>
      _remoteConfig.getString('ads_app_open_id');
